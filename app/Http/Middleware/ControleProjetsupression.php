...
class ControleProjetsupression
{
    /**
    ...
    public function handle(Request $request, Closure $next)
    {
        ...
        if($acces_lecture_tous_les_projets!=null&&$acces_supression!=null){
          return $next($request);
        }
      ...
      if($acces_lecture_par_division!=null&&$acces_supression!=null){
    ...
    if($acces_lecture!=null&&$acces_supression!=null){
